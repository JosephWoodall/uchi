...
```bash
# Start an interactive fluid chat session (Dual-Pass Routing enabled)
uchi

# Pre-train the compressed engine with massive context (like server logs or codebases)
uchi --preload data.txt
```
