...
> For detailed API usage, interactive examples, and to see the newest v0.2.0 capabilities (including online Math Learning, Vector Retrievals, and the Simulation Engine), please see the **[docs/](docs/README.md)** directory.
